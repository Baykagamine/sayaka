...
import requests,tempfile,cookielib
import timeit

cl = LINETCR.LINE()
cl.login(token="EoobNEXmEYKGuMCCdrge.jF2jqoWaS/CziGXELFQk3G.RMVVX6LffSeqJE+21DPZM+KthvoEYuBqIdbvQTBbqF8=")
cl.loginResult()
...
Pantau  =  Membuat set point
Sleding  =  Melihat sider dibawah read point
...
Setgroup =""" Private Menu 􀔃􀄆red check mark?
...
[BayBOT Squad join] = Invite semua bot
[Bye bots] = Mengeluarkan semua bots assist
[Bye Bay] = Mengeluarkan bot utama
[BayBOT out] = Mengeluarkan bot utama dari semua grup
...
Bots=[mid,Amid,Bmid,Cmid,"ue6a90acf5874b0937bbd57f5bbb951ba","uc052a9fdb48f165847a3aeecb7eb4bbe"]
admin=["ue6a90acf5874b0937bbd57f5bbb951ba","uc052a9fdb48f165847a3aeecb7eb4bbe"]
admsa=["ue6a90acf5874b0937bbd57f5bbb951ba","uc052a9fdb48f165847a3aeecb7eb4bbe"]
wait = {
    'contact':True,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks for adding me\n\nFollow my smule; www.smule.com/baykagamine\n\nMy Line ID : line.me/ti/p/~shunichiidesu\n",
    "lang":"JP",
	...
	if op.type == 13:
        ...
        if op.type == 26:
		   ...
		   if msg.toType == 2:
			  ...
			  if msg.from_ in admin:	
				md = ""
				if wait["Protectjoin"] == True: md+="􀔃􀆑lock?  Block Join\n"
				else: md+=" Block Join Off\n"
				if wait["Protectgr"] == True: md+="􀔃􀆑lock?   Block Group\n"
				else: md+=" Block Group Off\n"
				if wait["Protectcancl"] == True: md+="􀔃􀆑lock? Cancel All Invited\n"
			  ...
			  if msg.from_ in admin:
				if msg.toType == 2:
                    ...
                    cl.sendText(msg.to, "Masih Saya Pantau.")
                    try:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Pantau dulu jangan asal Sleding aja.")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Bay Squad join"]:
              if msg.from_ in admin:
            ...
            elif msg.text in ["BayBOT 1 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["BayBOT 2 join"]:
              if msg.from_ in admin:
                  x = cl.getGroup(msg.to)
                  x.preventJoinByTicket = False
                  cl.updateGroup(x)
            ...
            elif msg.text in ["BayBOT 3 join"]:
              if msg.from_ in admin:
                  X = cl.getGroup(msg.to)
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
...
#-----------------------------------------------
                ...
                try:
                    ...
                    user = "Name: " + text[-4] + " " + text[-3] + " " + text[-2] + "\n"
...
#------------------------------------------------
      ...
      #-------------Fungsi Respon Finish---------------------#
                  ...
                  try:
                      shi = msg.text.lower().replace("image ","")
            ...
            elif msg.text in ["Mamah Indah","Indah","indah"]:
                cl.sendText(msg.to,"Ohh dia itu orang Jogja yang hidungnya kayak jambu itu kan?")


            elif msg.text in ["Bay","bay"]:
                cl.sendText(msg.to,"Dia itu ikemen yang mengembangkan bot ini, orangnya baik juga loh.")


            elif msg.text in ["Akari","Rika","Kari","kari","Jerapah","jerapah"]:
                cl.sendText(msg.to,"Oalah, anak cewek yang suka baper itu? Biarin aja nanti juga diem sendiri.")


            elif msg.text in ["Erick","erick","mex","mexa","Mex","Mexa"]:
                cl.sendText(msg.to,"Yaa aku tau, Dia yang mesum itu kan? suka godain cewek gang sebelah.")


            elif msg.text in ["Grae","grae"]:
                cl.sendText(msg.to,"Dia itu kesayangannya Bay. Kalo ngomong sama Grae, Bay ga bisa ngomong 'enggak'.")


            elif msg.text in ["Graenii","graenii"]:
                cl.sendText(msg.to,"Si cantik dari Kota Palu itu kan? Cantik sih tapi kadang nyebelin.")

            elif msg.text in ["Padoru","padoru"]:
                cl.sendText(msg.to,"HASHIRE SHORI YO\nKAZE NO YOU NI\nTSUKIMI HARA WO\nPADORUU PADORUU.")
      ...
      #-------------Fungsi Bannlist Finish------------------#  
            ...
            elif msg.text.lower() == 'bay out all':
			  if msg.from_ in admsa:
				gid = cl.getGroupIdsJoined()
				...
				for i in gid:
					...
					kc.leaveGroup(i)
				if wait["lang"] == "JP":
					cl.sendText(msg.to,"BayKagamine bot leaving all groups.")
				else:
					cl.sendText(msg.to,"He declined all invitations")
            elif msg.text.lower() == 'baybot out':
			  if msg.from_ in admsa:
				gid = cl.getGroupIdsJoined()
				for i in gid:
					cl.leaveGroup(i)
				if wait["lang"] == "JP":
					cl.sendText(msg.to,"BayBOT bot leaving all groups.")
				else:
					cl.sendText(msg.to,"He declined all invitations")
